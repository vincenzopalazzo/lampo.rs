...
/// Lampo Daemon FFI to write a lightning node in dart
class LampoFFI {
  ...
  LampoFFI(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;
  ...
  late final _arc4random_bufPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<ffi.Void>, ffi.Int32)>>('arc4random_buf');
  ...
  int add_jsonrpc_on_unixsocket(
    ffi.Pointer<LampoDaemon> lampod,
  ) {
    return _add_jsonrpc_on_unixsocket(
      lampod,
    );
  }

  late final _add_jsonrpc_on_unixsocketPtr =
      _lookup<ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<LampoDaemon>)>>(
          'add_jsonrpc_on_unixsocket');
  late final _add_jsonrpc_on_unixsocket = _add_jsonrpc_on_unixsocketPtr
      .asFunction<int Function(ffi.Pointer<LampoDaemon>)>();
  ...
  late final _free_lampodPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<LampoDaemon>)>>(
          'free_lampod');
  late final _free_lampod =
      _free_lampodPtr.asFunction<void Function(ffi.Pointer<LampoDaemon>)>();
  ...
  void lampo_listen(
    ...
    return _lampo_listen(
      lampod,
    );
  }

  late final _lampo_listenPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<LampoDaemon>)>>(
          'lampo_listen');
  late final _lampo_listen =
      _lampo_listenPtr.asFunction<void Function(ffi.Pointer<LampoDaemon>)>();

  ffi.Pointer<ffi.Int8> lampod_call(
    ffi.Pointer<LampoDaemon> lampod,
  ...
  late final _lampod_callPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Int8> Function(ffi.Pointer<LampoDaemon>,
              ffi.Pointer<ffi.Int8>, ffi.Pointer<ffi.Int8>)>>('lampod_call');
  late final _lampod_call = _lampod_callPtr.asFunction<
      ffi.Pointer<ffi.Int8> Function(ffi.Pointer<LampoDaemon>,
          ffi.Pointer<ffi.Int8>, ffi.Pointer<ffi.Int8>)>();

  /// Allow to create a lampo daemon from a configuration patch!
  ffi.Pointer<LampoDaemon> new_lampod(
    ffi.Pointer<ffi.Int8> conf_path,
  ) {
    return _new_lampod(
      conf_path,
    );
  ...
  late final _new_lampodPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<LampoDaemon> Function(
              ffi.Pointer<ffi.Int8>)>>('new_lampod');
  late final _new_lampod = _new_lampodPtr
      .asFunction<ffi.Pointer<LampoDaemon> Function(ffi.Pointer<ffi.Int8>)>();
}
...
class LampoDaemon extends ffi.Opaque {}
