...
/// Lampo Deamon FFI to write a lightning node in dart
class LampoFFI {
  ...
  late final _add_jsonrpc_on_unixsocketPtr =
      _lookup<ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<LampoDeamon>)>>(
          'add_jsonrpc_on_unixsocket');
  late final _add_jsonrpc_on_unixsocket = _add_jsonrpc_on_unixsocketPtr
      .asFunction<int Function(ffi.Pointer<LampoDeamon>)>();
  ...
  late final _free_lampodPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<LampoDeamon>)>>(
          'free_lampod');
  ...
  late final _lampo_listen =
      _lampo_listenPtr.asFunction<void Function(ffi.Pointer<LampoDeamon>)>();
  ...
  late final _lampod_callPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Int8> Function(ffi.Pointer<LampoDeamon>,
  ...
  /// Allow to create a lampo deamon from a configuration patch!
  ffi.Pointer<LampoDeamon> new_lampod(
  ...
  late final _new_lampodPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<LampoDeamon> Function(
              ffi.Pointer<ffi.Int8>)>>('new_lampod');
  late final _new_lampod = _new_lampodPtr
      .asFunction<ffi.Pointer<LampoDeamon> Function(ffi.Pointer<ffi.Int8>)>();
}
...
class LampoDeamon extends ffi.Opaque {}
