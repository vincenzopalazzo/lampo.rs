...
pub fn json_new_addr(ctx: &LampoDaemon, request: json::Value) -> Result<json::Value> {
...
pub fn json_estimate_fees(ctx: &LampoDaemon, request: json::Value) -> Result<json::Value> {
